...
class __$$AuthStateInitialImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$AuthStateInitialImpl(
      status: null == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as AuthStatus,
...
class _$AuthStateInitialImpl implements AuthStateInitial {
  const _$AuthStateInitialImpl({this.status = AuthStatus.idle});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AuthStateInitialImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AuthStateInitialImplCopyWith<_$AuthStateInitialImpl> get copyWith =>
      __$$AuthStateInitialImplCopyWithImpl<_$AuthStateInitialImpl>(
          this, _$identity);
}

abstract class AuthStateInitial implements AuthState {
  const factory AuthStateInitial({final AuthStatus status}) =
      _$AuthStateInitialImpl;
